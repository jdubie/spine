...
(function() {
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.find = function(_id, params) {
      var record;
    ...
    Collection.prototype.fetch = function(params, options) {
      ...
      if (_id = params._id) {
        delete params._id;
        return this.find(_id, params).done(function(record) {
    ...
    Singleton.prototype.recordResponse = function(options) {
      ...
      return function(data, status, xhr) {
        ...
        Ajax.disable(function() {
          if (data) {
            if (data._id && _this.record._id !== data._id) {
              _this.record.changeID(data._id);
            }
  ...
  Include = {
    ...
    url: function() {
      ...
      url += encodeURIComponent(this._id);
      args.unshift(url);
      return args.join('/');
    }
  };
