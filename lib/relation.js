...
(function() {
  ...
  Spine = this.Spine || (typeof window !== "undefined" && window !== null ? window.require('spine') : void 0) || (typeof module !== "undefined" && module !== null ? module.require('spine') : void 0);

  Spine = (typeof window !== "undefined" && window !== null ? window.Spine : void 0) || (typeof window !== "undefined" && window !== null ? window.require('spine') : void 0) || (typeof module !== "undefined" && module !== null ? module.require('spine') : void 0);

  isArray = Spine.isArray;

  require = this.require || (function(value) {
    return eval(value);
  }) || (typeof module !== "undefined" && module !== null ? module.require('spine') : void 0);
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.refresh = function(values) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        record = _ref[_i];
        delete this.model.records[record._id];
      }
      ...
      for (_j = 0, _len1 = records.length; _j < _len1; _j++) {
        ...
        record[this.fkey] = this.record._id;
        this.model.records[record._id] = record;
      }
    ...
    Collection.prototype.associated = function(record) {
      return record[this.fkey] === this.record._id;
    };
  ...
  Instance = (function(_super) {
    ...
    Instance.prototype.update = function(value) {
      ...
      return this.record[this.fkey] = value && value._id;
    };
  ...
  Singleton = (function(_super) {
    ...
    Singleton.prototype.find = function() {
      return this.record._id && this.model.findByAttribute(this.fkey, this.record._id);
    };
    ...
    Singleton.prototype.update = function(value) {
      ...
      value[this.fkey] = this.record._id;
      return value.save();
    };
